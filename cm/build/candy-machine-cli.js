    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                ...
                warn = false;
                _b.label = 1;
            case 1: return [4 /*yield*/, upload_1.upload(files, cacheName, env, keypair, elemCount, storage, retainAuthority, mutable, ipfsCredentials, awsS3Bucket)];
            case 2:
                successful = _b.sent();
                if (successful) {
                    warn = false;
    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                ...
                cacheContent = cache_1.loadCache(cacheName, env);
                configAddress = new web3_js_1.PublicKey(cacheContent.program.config);
                return [4 /*yield*/, mint_1.mint(keypair, env, configAddress)];
            case 1:
                tx = _b.sent();
